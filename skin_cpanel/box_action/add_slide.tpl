    ...
    <div class="box_right_content">
        <div class="box_profile">
            <div class="page_title">
                <h1 class="undefined">Thêm slide mới</h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_50">
                ...
                <div class="form_group">
                    ...
                    <input type="text" class="form_control" name="link" value="" placeholder="Nhập link...">
                </div>
                <div class="form_group">
            ...
            <div style="clear: both;"></div>
            <div class="form_group">
                <button class="button_all" name="add_slide"> Hoàn thành </button>
            </div>
        </div>
    </div>
</div>