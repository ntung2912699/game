        ...
        <div class="box_profile">
            ...
            <div class="col_50">
                <div class="form_group">
                    ...
                    <input type="text" class="form_control tieude_seo" name="tieu_de" onkeyup="check_blank();" value="" placeholder="Nhập tiêu đề...">
                </div>
                <div class="form_group">
                ...
                <div class="form_group">
                    ...
                    <input type="file" id="minh_hoa" class="form_control" name="minh_hoa" placeholder="Nhập linh ảnh minh họa">
                </div>
            </div>
            <div style="clear: both;"></div>
            <div class="col_100">
                ...
                <div class="form_group">
                    ...
                    <textarea name="short_description" class="form_control" placeholder="Nhập mô tả ngắn cho bài viết" style="width: 100%;height: 95px;"></textarea>
                </div>
                <div class="form_group">
