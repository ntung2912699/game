						...
						<div class="col_right_left_content">
							...
							<div class="box_info_account">
								...
								<div class="midle_content" style="min-height: 400px;">
									<div class="title_content">Thông tin tài khoản</div>
									<div class="box_text_content" style="width: 460px;">
										<div class="tr_info">
											<div class="tr_left">Tài khoản: </div>
											<div class="tr_right">{loginName}</div>
										</div>
										<div class="tr_info">
											<div class="tr_left">Email: </div>
											<div class="tr_right">{cEMail}</div>
										</div>
										<div class="tr_info">
											<div class="tr_left">Số Coin: </div>
											<div class="tr_right">{Coin}</div>
										</div>
									</div>
								</div>
